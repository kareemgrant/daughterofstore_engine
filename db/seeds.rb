...
User.create(full_name: "Wolverine", email: "wolverine@example.com", password: "password")
User.create(full_name: "Ironman", email: "ironmanw@example.com", password: "password")
User.create(full_name: "Batman", email: "batman@example.com", password: "password")
User.create(full_name: "Magneto", email: "magneto@example.com", password: "password")
...
Auction.create(store_id: store1.id, duration: 3, starting_bid: 0, shipping_options: 'International', active: true)
